...
// Parameters: adjust these for desired performance
	...
	private static final int bandCenter = 40;			// Offset from the wall (cm)   // was 50
	private static final int bandWidth = 10;				// Width of dead band (cm)      // was originally 15 testing 10
	private static final int motorLow = 50;				// Speed of slower rotating wheel (deg/sec)
	private static final int motorHigh = 400; 			// Speed of the faster rotating wheel (deg/seec)
	private static final int motorNormal = 150; 
// Static Resources:
//
...
// Main entry point - instantiate objects used and set up sensor
	...
	public static void main(String [] args) {
		...
		BangBangController bangbang = new BangBangController(leftMotor, rightMotor,
															 bandCenter, bandWidth, motorLow, motorHigh, motorNormal);
