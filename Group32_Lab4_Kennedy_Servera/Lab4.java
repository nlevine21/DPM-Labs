...
public class Lab4 {
	...
	public static void main(String[] args) {
		...
		if (buttonChoice == Button.ID_LEFT) {//ultrasonic sensor localization 
			usl.doLocalization();
		} else { // light localization
			lsl.doLocalization();
		}
		...
		}		while (buttonChoice2 != Button.ID_LEFT
				&& buttonChoice2 != Button.ID_RIGHT);
		if (buttonChoice2 == Button.ID_LEFT) {//ultrasonic sensor localization 
			usl.doLocalization();
		} else { // light localization
			lsl.doLocalization();
		}
